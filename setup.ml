...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33dbf2754de6257d625189f3b4020531) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/containers-lwt";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "compile benchmarks";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("containers_misc", None)
                        ];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "containers_lwt";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "run_bench_io";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "run_bench_io.ml"});
               Doc
                 ({
                     cs_name = "containers-lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("containers", None);
                           FindlibPackage ("containers-lwt", None);
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/containers-lwt/tree/master/src";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\196\026\145\242\1914\017=\195y?\197k\011\220\031";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
